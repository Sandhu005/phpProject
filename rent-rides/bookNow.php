    ...
    <div class="container-fluid bg-breadcrumb">
        <div class="container text-center py-5" style="max-width: 900px;">
            ...
            <ol class="breadcrumb d-flex justify-content-center mb-0 wow fadeInDown" data-wow-delay="0.3s">
                ...
                <li class="breadcrumb-item active text-primary">Car Reservation</li>
            </ol>
        </div>
    </div>
    <!-- Header End -->
     ...
     <body>
                                     ...
                                     <div class="col-lg-6 fadeInLeft animated" data-animation="fadeInLeft" data-delay="1s" style="animation-delay: 1s;">
                                         <div class="bg-secondary rounded p-5">
                                             ...
                                             <form action="" method="post">
                                                 <div class="row g-3">
                                                     <div class="col-12">
                                                         <select class="form-select" aria-label="Default select example" name="car_id" onchange="fetchPrice(this.value)">
                                                             <?php
                                                                if (isset($_GET['car_id'])) {
                                                     ...
                                                     <div class="col-12">
                                                         <div class="input-group">
                                                             ...
                                                             <input class="form-control" type="text" disabled name="price_per_day" id="price_per_day">
                                                         </div>
                                                     </div>
                                                 </div>
                                         </div>
         ...
         <script>
             function fetchPrice(carId = "") {
                 ...
                 xhr.open("GET", "carPrice.php?carId=" + carId, true);
                 xhr.onload = function() {
                     document.getElementById("price_per_day").value = xhr.responseText;
                 }
                 xhr.send();
             }
             fetchPrice();
